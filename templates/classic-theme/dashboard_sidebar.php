            ...
            <div class="dashboard-nav">
                <div class="dashboard-nav-inner">
                    <ul data-submenu-title="<?php _e("My Account") ?>">
                        ...
                        <li class="<?php echo CURRENT_PAGE == 'app/all-images' || CURRENT_PAGE == 'app/all-documents' || CURRENT_PAGE == 'app/all-speeches' ? 'active-submenu' : ''; ?>">
                            ...
                            <ul>
                                ...
                                <?php if ($config['enable_ai_images'] && (get_option('hide_plan_disabled_features') && $plan_settings['ai_images_limit'])) { ?>
                                    <li class="<?php echo CURRENT_PAGE == 'app/all-images' ? 'active' : ''; ?>"><a
                                                href="<?php url("ALL_IMAGES") ?>"><?php _e("All AI Images") ?></a></li>
                                <?php }

                                if (get_option('enable_text_to_speech', 0) && (get_option('hide_plan_disabled_features') && $plan_settings['ai_text_to_speech_limit'])) { ?>
                    ...
                    <ul data-submenu-title="<?php _e("Organize and Manage") ?>">
                        ...
                        <li class="<?php echo CURRENT_PAGE == 'app/ai-bidding' || CURRENT_PAGE == 'app/auto-bidding' ? 'active' : ''; ?>">
                            <a
                                    href="<?php url("AI_BIDDING") ?>"><i
                                        class="icon-feather-dollar-sign"></i> <?php _e("AI Bidding") ?></a>
                            <ul>
                                <li class="<?php echo CURRENT_PAGE == 'app/ai-bidding' ? 'active' : ''; ?>">
                                    <a href="<?php url("AI_BIDDING") ?>"><?php _e("AI Bidding") ?></a>
                                </li>
                                <li class="<?= CURRENT_PAGE == 'app/auto-bidding' ? 'active' : ''; ?>"><a
                                            href="<?php url("AUTO_BIDDING") ?>"><?php _e("Auto Bidding") ?></a>
                                </li>
                            </ul>
                        </li>
                        <li class="<?php echo CURRENT_PAGE == 'app/resume-template' ? 'active' : ''; ?>">
                            <a href="<?php url("RESUME_TPL") ?>"><i
                                        class="icon-feather-file-plus"></i> <?php _e("AI Resume") ?></a>
                        </li>
                    </ul>
