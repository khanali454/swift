...
$router->map('POST','/freelancer-login/?', 'app/freelancer-login.php');
$router->map('GET|POST','/ai-bidding/?', 'app/ai-bidding.php');
$router->map('GET|POST','/ai-bidding/apply?', 'app/ai-bidding-apply.php');
$router->map('GET|POST','/auto-bidding', 'app/auto-bidding.php');
$router->map('GET|POST','/auto-bidding/settings', 'app/auto-bidding-setting.php');
$router->map('GET|POST','/freelancer-logout', 'app/freelancer-logout.php');
