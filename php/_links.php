...
$link['AI_BIDDING'] = $config['site_url'] . 'ai-bidding';
$link['AI_BIDDING_APPLY'] = $config['site_url'] . 'ai-bidding/apply';
$link['AUTO_BIDDING'] = $config['site_url'] . 'auto-bidding';
$link['AUTO_BIDDING_SETTING'] = $config['site_url'] . 'auto-bidding/settings';
$link['FREELANCER_LOGIN'] = $config['site_url'] . 'freelancer-login';
$link['FREELANCER_LOGOUT'] = $config['site_url'] . 'freelancer-logout';
