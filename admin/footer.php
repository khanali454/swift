    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-6 footer-copyright">
                <p class="mb-0"><?php _e('Copyright') ?> © <?php _esc(date('Y'))  ?> <a href="https://apextreasuresoftware.com" target="_blank">Apex Treasure Sdn. Bhd.</a>. <?php _e('All rights reserved.') ?> </p>
            </div>
            <div class="col-md-6">
