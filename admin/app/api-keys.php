...
if (!empty($_GET['refresh-balance'])) {
    ...
    if ($row['type'] == 'stable-diffusion') {
        ...
        $balance = "<label class='badge badge-info'>Failed</label>";
    }
    ...
    <div class="page-body">
        ...
        <div class="container-fluid">
            <div class="alert alert-info">
                ...
                <strong>Note:</strong> OpenAI disabled their balance API so right now there is no way to check the balance. Whenever they will enable the API, we will enable this feature.
            </div>
